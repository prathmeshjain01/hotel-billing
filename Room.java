...
{                                         
        try
       {
          pst=cn.prepareStatement("insert into room values(?,?,?,?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
     try
   {
       pst=cn.prepareStatement("update room set rtype=?, rate=?, rdesc=? where rid=?");
   ...
   catch(Exception e)
  {
   JOptionPane.showMessageDialog(null,"Error in edit = "+e);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        try
   {
       pst=cn.prepareStatement("delete  from room where rid=?");
 ...
 private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
     try
    {
    pst=cn.prepareStatement(" select * from room where rid=? ");   
      int id=Integer.parseInt(t1.getText());
     pst.setInt(1,id);
     rs=pst.executeQuery();
       if(rs.next())
