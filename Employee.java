...
{                                         
	 ...
	 pst.setString(3,t3.getText());
         ...
         pst.execute();
         JOptionPane.showMessageDialog(null,"Emp Added.... ");
    t1.setText("");
    t2.setText("");
    t3.setText("");
    t4.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
     try
   {
       pst=cn.prepareStatement("update emp set ename=?, cellno=?, desig=?where eid=?");
   ...
   catch(Exception e)
  {
   JOptionPane.showMessageDialog(null,"Error in edit = "+e);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        try
   {
       pst=cn.prepareStatement("delete  from emp where eid=?");
 ...
 private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
     try
    {
    pst=cn.prepareStatement(" select * from emp where eid=? ");   
      int id=Integer.parseInt(t1.getText());
     pst.setInt(1,id);
     rs=pst.executeQuery();
       if(rs.next())
