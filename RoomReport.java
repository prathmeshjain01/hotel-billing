...
class RoomReport
{
 ...
 Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/Hotel","postgres","system");
    		...
    		BufferedWriter bw=new BufferedWriter(new FileWriter("RoomReport.html"));
    		bw.write("<html>");
    		...
    		bw.write("<h2><center> <font color='green'>ROOM DETAILS REPORT </font></center></h1>");
